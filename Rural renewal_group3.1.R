...
input_file <- 'Rural renewal data_group3.1.csv'
...
# The outcome variable of the group 3 is O21 and O31.
# And O21 and O31 coexist in the group 3.
out_a <- 'O21'  # <======= plug in the name of the outcome attribute here
...
write.csv2(metrics, file='Wang-2019_metrics_group3.1.csv')
