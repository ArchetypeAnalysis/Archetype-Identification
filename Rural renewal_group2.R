...
input_file <- 'Rural renewal data_group2.csv'
...
df <- read.csv(input_file, 
               ...
               na.strings=c('', 'NA'))
n_cases <- nrow(df)
# The outcome variable of the group 2 is O12
out_a <- 'O12' # <======= plug in the name of the outcome attribute here
...
write.csv2(metrics, file='Wang-2019_metrics_group2.csv')
